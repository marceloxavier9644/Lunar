...
namespace Lunar.RJ_UI.Classes
{
    ...
    public partial class RJTextBoxLower : UserControl
    {
        #region -> Fields
        //Fields
        ...
        public bool PasswordChar
        {
            ...
            set
            {
                ...
                if (!isPlaceholder)
                    textBox2.UseSystemPasswordChar = value;
            }
        }
        ...
        {
            if (string.IsNullOrWhiteSpace(textBox2.Text) && placeholderText != "")
            {
                isPlaceholder = true;
