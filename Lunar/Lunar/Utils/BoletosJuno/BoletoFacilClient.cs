...
namespace Lunar.Utils.BoletosJuno
{
    public class BoletoFacilClient
    {
        ...
        public void GerarCobrancaJuno(Payer payer, Charge charge)
        {
            BoletoFacil boletoFacil = new BoletoFacil(BoletoFacilEnvironment.Sandbox, Sessao.tokenJuno);
            ...
            charge.Payer = payer;
            charge.PaymentTypes = PaymentType.BOLETO;
