...
namespace LunarBase.ClassesDAO
{
    public class CaixaAberturaDAO : BaseDAO
    {
        ...
        {
            Session = Conexao.GetSession();
            String sql = "FROM CaixaAbertura Tabela WHERE Tabela.DataAbertura between '" + dataInicial + " 00:00:00' and '" + dataFinal + " 23:59:59' and Tabela.Status = 'ABERTO' and Tabela.FlagExcluido <> true";
            IList<CaixaAbertura> retorno = Session.CreateQuery(sql).List<CaixaAbertura>();
            return retorno;
        }
