...
{
    private static string token = "VFhUIElORk9STUFUSUNBT3JQSEQ=";
    ...
    public static string inutilizarNumeracaoESalvar(string modelo, InutilizarReq InutilizarReq, string caminho, string cnpjEmitente, bool a3 = false)
    {
            ...
            case "67":
                {
                    ...
                    {
                        if(InutilizarRespCTe.retornoInutCTe != null)
                        {
                            MessageBox.Show(InutilizarRespCTe.retornoInutCTe.xMotivo);
                        }
                    }
                    break;
                }
            ...
            case "55":
                {
                    ...
                    {
                        if (InutilizarRespNFe.retornoInutNFe != null)
                        {
                            MessageBox.Show(InutilizarRespNFe.retornoInutNFe.xMotivo);
                        }
                    }
                    break;
                }
        ...
        {
            if (!Directory.Exists(caminho)) Directory.CreateDirectory(caminho);
            Genericos.salvarXML(xml, caminho, chave + "-INU");
        }
